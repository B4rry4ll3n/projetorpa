...
public class Colaborador {
	...
	public Colaborador( Integer id, String nome, int id_Colaborador_TCS, String cargo,
			String especialidade, String status, LocalDate date, String contato_email, String contato_telefone,
			String localizacao, Gestor gestor) {
		super();
		this.sdf = sdf;
		this.id = id;
		this.nome = nome;
	...
	public String toString() {
		return "Colaborador [id=" + id + ", nome=" + nome + ", id_Colaborador_TCS="
				+ id_Colaborador_TCS + ", cargo=" + cargo + ", especialidade=" + especialidade + ", status=" + status
				+ ", date=" + date + ", contato_email=" + contato_email + ", contato_telefone=" + contato_telefone
				+ ", localizacao=" + localizacao + ", gestor=" + gestor + "]";
	}
